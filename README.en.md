...
| Douyu browse / rooms / playback / danmaku | Done; sending succeeded in a personal room and still needs a complete local Cookie plus per-send confirmation/real-echo handling |
