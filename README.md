...
| 醒目留言 SC 面板（哔哩哔哩） | 完成 Done（金额标题带、完整正文、时长与金额层级） |
...
5. **主播信息 / SC / 关注**：右栏顶部显示主播头像、用户名、所属平台和当前热度；「SC」仅展示哔哩哔哩醒目留言，金额档位安全颜色构成紧凑标题带，突出金额、发送者与置顶时长并完整显示正文；其他平台会明确提示尚未接入 SC。「关注」可直接切换到任一已关注房间，无需先退出当前房间。关注页顶部可按「全部平台」或单个平台筛选；关注状态按钮仅有「全部 / 直播中 / 未开播」，右下角浮动按钮刷新开播状态。
