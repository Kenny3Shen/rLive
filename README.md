...
| 房间内弹幕设置（区域 / 行数 / 透明度 / 字号 / 字重 / 速度 / 重复 / 礼物过滤 / 屏蔽词 / SC / 自动发送）                    | 已完成；自动发送仅在 B 站 / 斗鱼 / 虎牙房间会话中生效                              |
