...
use commands::video::{
    ...
    video_get_season, video_get_story, video_get_storyboard, video_get_subtitle,
    video_get_subtitles, video_get_uploader_story, video_get_zone, video_search,
...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            video_get_season,
            video_get_play_info,
            commands::douyin_video::douyin_video_feed,
