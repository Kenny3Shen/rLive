...
const settingsCategorySearchText: Record<SettingsCategory, string> = {
  playback:
    "播放 外观 主题 深色 暗色 浅色 亮色 播放质量 清晰度 线路记忆 软切换 语音 字幕 asr zipformer 标点 说话人 热词 刷新间隔 CUDA NVIDIA GPU 推理后端 弹幕 轨道 区域 行数 文字 透明度 字号 字重 过滤 屏蔽词 重复 礼物 合并 醒目留言 sc 恢复默认 重置 reset",
