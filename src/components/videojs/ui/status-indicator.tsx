    ...
    >
      <div className={cn("items-center justify-between gap-2 px-2.5 py-1", "flex", "w-full")}>
        <CaptionsOnIconPrimitive
          className={
            "hidden shrink-0 group-data-[status=captions-on]/input-status:block mix-blend-difference"
          }
        />
        <CaptionsOffIconPrimitive
          className={
            "hidden shrink-0 group-data-[status=captions-off]/input-status:block mix-blend-difference"
          }
        />
        <FullscreenEnterIconPrimitive
          className={
            "hidden shrink-0 group-data-[status=fullscreen]/input-status:block mix-blend-difference"
          }
        />
        <FullscreenExitIconPrimitive
          className={
            "hidden shrink-0 group-data-[status=exit-fullscreen]/input-status:block mix-blend-difference"
          }
        />
        <PipEnterIconPrimitive
          className={
            "hidden shrink-0 group-data-[status=pip]/input-status:block mix-blend-difference"
          }
        />
        <PipExitIconPrimitive
          className={
            "hidden shrink-0 group-data-[status=exit-pip]/input-status:block mix-blend-difference"
          }
        />
