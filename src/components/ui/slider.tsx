      ...
      >
        <SliderPrimitive.Track
          ...
          className={cn(
            ...
            variant === "player"
              ? "bg-white/25 transition-[height] duration-150 group-hover/player-slider:data-horizontal:h-1.5 keyboard-nav:group-focus-within/player-slider:data-horizontal:h-1.5 motion-reduce:transition-none"
              : "bg-muted",
          )}
        >
        ...
        {Array.from({ length: values.length }, (_, index) => (
          <SliderPrimitive.Thumb
            ...
            className={cn(
              ...
              variant === "player"
                ? "border-0 bg-white opacity-0 shadow-sm ring-white/40 transition-[opacity,box-shadow] group-hover/player-slider:opacity-100 keyboard-nav:group-focus-within/player-slider:opacity-100 hover:ring-3 active:opacity-100 active:ring-3"
