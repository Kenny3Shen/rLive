  ...
  switch (siteId) {
    ...
    case "huya":
      return (
        <svg viewBox="0 0 48 48" className={svgClassName} aria-hidden="true">
          ...
          />
          <path
            d="m18 24 4 2m8-2-4 2m-8 6 6 3 6-3"
            fill="none"
            stroke="white"
            strokeLinecap="round"
            strokeLinejoin="round"
    ...
    case "douyin":
      return (
        <svg viewBox="0 0 48 48" className={svgClassName} aria-hidden="true">
          <path
            d="M28 7v20.5a8 8 0 1 1-5-7.4V14c3.5 4.1 7.8 6.2 13 6.2v7c-3.1 0-5.8-.8-8-2.2V31a12 12 0 1 1-9-11.6V7h9Z"
            fill="#25F4EE"
